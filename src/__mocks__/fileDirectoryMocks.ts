...
export const MOCK_DATA_1:ITreeNode[] = [
    {
        type: 'folder',
        name: 'Files',
        modified: new Date('2025-03-21T00:00:00Z'),
        size: 0,
        children: [
            {
                type: 'folder',
                name: 'Documents',
                modified: new Date('2020-07-06T00:00:00Z'),
                size: 0,
                children: [
                    {
                        type: 'folder',
                        name: 'Documents_subfolder1',
                        modified: new Date('2025-02-28T00:00:00Z'),
                        size: 0,
                        children: [
                            {
                                type: 'file',
                            ...
                            },
                            {
                                ...
                                modified: new Date('2020-02-23T00:00:00Z'),
                                size: 30
                            },
                            {
                                type: 'file',
                    ...
                    },
                    {
                        ...
                        modified: new Date('2020-02-28T00:00:00Z'),
                        size: 15
                    },
                ]
            }, {
                ...
                type: 'folder',
                name: 'System',
                modified:  new Date('2023-04-28T00:00:00Z'),
                size: 0,
                children: [
                    {
                        type: 'file',
                        ...
                        children: [
                            {
                                ...
                                modified: new Date('2023-02-28T00:00:00Z'),
                                size: 20
                            }
                        ]
                    },
    ...
    },
    {
        type: 'folder',
        name: 'Applications',
        modified: new Date('2020-08-09T00:00:00Z'),
        size: 0,
        children: [
            {
                type: 'file',
